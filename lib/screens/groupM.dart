...
class _GroupMaizePageState extends State<GroupMaizePage> {
  final List<Map<String, String>> posts = [
    {
      'title': 'Fall Armyworm Maize',
      'desc':
          'Fall armyworm is an invasive pest that attacks maize and other crops, causing severe damage by feeding on leaves, stems, and ears. It is highly destructive and spreads quickly, especially in warm climates, making early detection and control essential to prevent major yield losses.',
      'image': 'assets/army.jpeg',
    },
    {
      'title': 'Fall Armyworm Maize',
      'desc':
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            color: Color(
              0xFFF5F5F5,
            ), // Light grey background (darker than default white)
